...
//               <div>
//                 <label className="block text-sm font-bold mb-1 text-gray-800">Nama Lengkap</label>
//                 <input
//                   type="text"
...
//               </div>
//               <div>
//                 <label className="block text-sm font-bold mb-1 text-gray-800">Konfirmasi Password</label>
//                 <input
//                   type="password"
...
import firebaseApp from '../../../lib/firebase/init'; // Pastikan path ini sesuai
...
export default function Signup() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const namaLengkap = (form.elements.namedItem('namalengkap') as HTMLInputElement).value;
    ...
    try {
      ...
      if (err.code === 'auth/email-already-in-use') {
        ...
        setError('Konfigurasi API Key Firebase salah atau tidak ditemukan');
      } else {
