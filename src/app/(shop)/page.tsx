    ...
    <main className="font-sans bg-white">
      ...
      <section className="bg-white py-8">
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 text-center">
            <div className="p-4 border rounded text-[#1C1501] w-64">
              🌐 Booking Janji Temu
            </div>
            <div className="p-4 border rounded text-[#1C1501] w-64">
              📞 Hubungi Kami
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <h2 className="text-2xl font-bold mb-2 text-[#1C1501]">
            Koleksi Terbaru
          </h2>
          <p className="text-[#1C1521] mb-10">
            Ikuti tren dengan pilihan gaya terlaris yang telah kami pilih
          </p>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-left w-full">
                <div className="relative rounded-xl overflow-hidden">
                  <Image
                    src="/images/gamis-pernikahan.jpg"
                    alt={`Koleksi ${i}`}
                    width={400}
                    height={400}
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <h2 className="text-2xl font-bold text-[#1C1501] mb-6">
            Produk Kami
          </h2>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { src: "/images/laut-kaftan.jpg", title: "Tunic" },
              { src: "/images/phinisi-gown.jpg", title: "Gaun" },
              { src: "/images/senja-outer.jpg", title: "Outerwear" },
            ].map((item, i) => (
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {[{ name: "Andini" }, { name: "Andika" }].map((user, i) => (
              <div
                key={i}
                className="bg-[#F7C100] rounded shadow-md p-6 text-left text-[#1C1501]"
              >
